...
public class DB_CCMIdToSuggestionId {
        ...
        try (FileInputStream file = new FileInputStream(FILE_PATH);
            ...
            while (iterator.hasNext()) {
                ...
                if (ccmId.equals(id)) {
                    ...
                    suggestionIds.add(row.getCell(1, Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).getStringCellValue());
                }
            }
        ...
        try (FileInputStream file = new FileInputStream(FILE_PATH);
            ...
            while (iterator.hasNext()) {
                ...
                if (suggestionId.equals(id)) {
                    // Found a mapping for the suggestionId
    ...
    public static void updateMapping(String ccmId, String newSuggestionId) {
        try (FileInputStream file = new FileInputStream(FILE_PATH);
             Workbook workbook = new XSSFWorkbook(file)) {
            ...
            while (iterator.hasNext()) {
                ...
                if (ccmId.equals(id)) {
                    ...
                    row.getCell(1, Row.MissingCellPolicy.CREATE_NULL_AS_BLANK).setCellValue(newSuggestionId);
    ...
    public static ArrayList<String> getAllSuggestionIds() {
        ArrayList<String> suggestionIds = new ArrayList<>();
